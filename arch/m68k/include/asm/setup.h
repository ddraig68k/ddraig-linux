...
#  define MACH_IS_MACKEREL (0)
	...
	|| defined(CONFIG_Q40)                                              \
	|| defined(CONFIG_VIRT)
#  define MACH_IS_MACKEREL (m68k_machtype == MACH_MACKEREL)
#else
#  define MACH_MACKEREL_ONLY
#  define MACH_IS_MACKEREL (1)
#  define MACH_TYPE (MACH_MACKEREL)
#endif
