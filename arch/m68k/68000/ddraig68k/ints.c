...
// Y Ddraig interrupt controller setup.
// All interrupt sources are autovectored; there is no INTC masking register.
...
void __init trap_init(void)
{
	...
	/* Autovectors: IRQ1=EXP1, IRQ2=IDE, IRQ3=PIT, IRQ4=DUART, IRQ5=PS2 */
